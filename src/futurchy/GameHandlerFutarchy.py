...
class GameHandler:
    ...
    def get_phase_description(self, phase_number, role=None):
        ...
        phase_descriptions = {
            ...
            2: f"Declaration Phase: Each player owning a property must declare the expected revenue for the round. The declaration should reflect the most accurate and strategic revenue estimates based on current market conditions, property values, and potential outcomes. The first two items should represent the revenue under different conditions (status quo and project development), and the third item, although initially intended for a different project, should be set to 0.\n\nPlease consider all available data, including property values, recent market trends, and the strategic position of other players when declaring these values.\n\nExpected JSON Output:\n{{\n    \"content\": {{\n        \"gameId\": {self.game_id},\n        \"type\": \"declare\",\n        \"declaration\": [\n            598000,\n            215000,\n            0\n        ]\n    }},\n    \"number\": {self.user_number},\n    \"tag\": \"{role_name}\",\n    \"phase\": 2,\n    \"round\": {self.current_round},\n    \"type\": \"message\"\n}}",
