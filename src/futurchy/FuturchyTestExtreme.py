from GameHandlerFutarchy import GameHandler  # Adjust the import as necessary
import time
...
messages = [
    ...
    '{"type":"event","eventType":"add-order","data":{"order":{"id":1,"sender":2,"price":5,"quantity":1,"type":"ask","condition":1}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":2,"sender":2,"price":5,"quantity":1,"type":"bid","condition":1}}}',
    '{"type":"event","eventType":"contract-fulfilled","data":{"from":4,"to":2,"price":5,"condition":1,"median":5}}',
    '{"type":"event","eventType":"delete-order","data":{"order":{"id":2,"type":"bid","condition":1}}}',
    '{"type":"event","eventType":"contract-fulfilled","data":{"from":2,"to":4,"price":5,"condition":0,"median":5}}',
    '{"type":"event","eventType":"delete-order","data":{"order":{"id":1,"type":"ask","condition":1}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":3,"sender":3,"price":5,"quantity":1,"type":"ask","condition":0}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":4,"sender":3,"price":5,"quantity":1,"type":"bid","condition":1}}}',
    '{"type":"event","eventType":"contract-fulfilled","data":{"from":3,"to":2,"price":5,"condition":1,"median":5}}',
    '{"type":"event","eventType":"delete-order","data":{"order":{"id":3,"type":"ask","condition":1}}}',
    '{"type":"event","eventType":"contract-fulfilled","data":{"from":2,"to":3,"price":5,"condition":0,"median":5}}',
    '{"type":"event","eventType":"delete-order","data":{"order":{"id":4,"type":"bid","condition":1}}}',
    ...
    '{"type":"event","eventType":"add-order","data":{"order":{"id":5,"sender":3,"price":5,"quantity":1,"type":"ask","condition":0}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":6,"sender":4,"price":5,"quantity":1,"type":"ask","condition":0}}}',
    '{"type":"event","eventType":"contract-fulfilled","data":{"from":2,"to":3,"price":5,"condition":1,"median":5}}',
    '{"type":"event","eventType":"delete-order","data":{"order":{"id":4,"type":"bid","condition":1}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":5,"sender":3,"price":5,"quantity":1,"type":"ask","condition":0}}}',
    '{"type":"event","eventType":"add-order","data":{"order":{"id":6,"sender":4,"price":5,"quantity":1,"type":"ask","condition":0}}}',
